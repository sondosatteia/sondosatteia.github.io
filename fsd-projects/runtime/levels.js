...
const LEVELS = [
  {
    ...
    speed: 2,
    gameObjects: [
      { type: "obstacle", kind: "spikes", x: 750, y: groundY - 150 },
      { type: "enemy", kind: "bug", x: 1600, y: groundY },
       { type: "enemy", kind: "bug", x: 500, y: groundY - 150},
      { type: "powerup", kind: "healthUp", x: 1600, y: groundY - 50 },
       { type: "powerup", kind: "healthUp", x: 1100, y: groundY - 170 },
      {
        type: "platform",
        kind: "basicPlatform",
        x: 700,
      ...
      { type: "platform", kind: "basicPlatform", x: 400, y: groundY - 100 },
      {
        type: "platform",
        kind: "basicPlatform",
        x: 200,
